package debug.swift.android.sample
...
import debug.swift.android.AndroidDebugTools
import debug.swift.android.DebugSwiftComposeProbe
...
internal val logger: SkipLogger = SkipLogger(subsystem = "debug.swift.android.sample", category = "DebugSwiftAndroidSample")

private typealias AppRootView = DebugSwiftAndroidSampleRootView
private typealias AppDelegate = DebugSwiftAndroidSampleAppDelegate
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onCreate(savedInstanceState: android.os.Bundle?) {
        ...
        AndroidDebugTools.reportIntent(intent)
    ...
    override fun dispatchTouchEvent(event: MotionEvent): Boolean {
        AndroidDebugTools.recordTouch(event)
